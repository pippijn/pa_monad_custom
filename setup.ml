...
(* OASIS_START *)
(* DO NOT EDIT (digest: ea442b36ef73b6ff929c49247f2b5246) *)
(*
...
let setup_t =
  {
       ...
       CustomPlugin.Build.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("make", ["all"; "META"]))];
     ...
     install =
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("make", ["findlib-install"]))];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)];
            };
     uninstall =
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("make", ["findlib-uninstall"]))];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)];
            };
     clean =
     ...
     package =
       {
          ...
          authors =
            [
               ...
               "Lydia E. van Dijk";
               "<lvandijk AT freenet DOT de>";
               "Oleg Kiselyov";
               "<oleg AT pobox DOT com>";
               "Jun FURUSE"
            ];
          homepage = None;
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_monad"];
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "monad-custom";
